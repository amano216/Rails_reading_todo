const questions = [
    ...
    },
    {
        ...
        correct: 0,
        explanation: "rails newコマンドは新しいRailsアプリケーションを作成します。my_appは作成するアプリケーションの名前です。"
    },
    {
        id: 3,
        level: "超初級",
    ...
    },
    {
        ...
        correct: 0,
        explanation: "rails server（または rails s）は開発用サーバーを起動し、http://localhost:3000 でアプリケーションにアクセスできるようになります。"
    },
    {
        id: 5,
        level: "超初級",
    ...
    },
    {
        ...
        correct: 0,
        explanation: "ApplicationRecordを継承したクラスはModelです。この例ではUserモデルで、nameの必須バリデーションを設定しています。"
    },
    {
        id: 7,
        level: "超初級",
    ...
    },
    {
        ...
        correct: 0,
        explanation: "ApplicationControllerを継承したクラスはControllerです。この例ではUsersControllerのindexアクションで全ユーザーを取得しています。"
    },
    {
        id: 9,
        level: "超初級",
    ...
    },
    {
        ...
        category: "コマンド基礎",
        question: "次のコマンドは何をしますか？",
        code: "rails generate controller Welcome index",
        options: [
            "Welcomeコントローラーとindexアクションを作成",
            "Welcomeモデルを作成",
            "Welcomeデータベースを作成",
            "Welcomeビューのみを作成"
        ],
        correct: 0,
        explanation: "rails generate controllerコマンドは、指定した名前のコントローラーとアクションを作成します。"
    },
    {
        id: 11,
        level: "超初級",
